...
const Contact = ()=>{
    const { values, errors, touched, status, handleBlur, handleChange, handleSubmit } = useFormik({
        ...
        onSubmit: (values, action) => {
            axios({
                method: "POST",
                url: "https://formspree.io/f/xrgvwqyy",
                data: values
              }).then(response => {
            console.log(values)
            action.resetForm();
    ...
    <div className={classes['row']}>
        ...
        +923150053739
            ...
            <ul className={classes['social-ul']}>
                <li className={classes['social-li']}><a href='https://www.facebook.com/m.u.m.d.u.1234'><FacebookRoundedIcon className={classes['social-icon']} sx={{fontSize:'4rem', transition:'all.2s'}}/></a></li>
                <li className={classes['social-li']}><a href='https://twitter.com/MuhammadMehdi72'><TwitterIcon className={classes['social-icon']} sx={{fontSize:'4rem', transition:'all.2s'}}/></a></li>
                <li className={classes['social-li']}><a href='https://www.instagram.com/m_mehdi72/'><InstagramIcon className={classes['social-iconIns']} sx={{fontSize:'4rem', transition:'all.2s'}}/></a></li>
                <li className={classes['social-li']}><a href='https://github.com/m-mehdi72'><GithubIcon className={classes['social-icons']} sx={{fontSize:'4rem', transition:'all.2s'}}/></a></li>
                <li className={classes['social-li']}><a href='https://www.linkedin.com/in/muhammad-mehdi-770209247/'> <LinkedInIcon className={classes['social-icon']} sx={{fontSize:'4rem', transition:'all.2s'}}/></a></li>
            </ul>
        </div>
